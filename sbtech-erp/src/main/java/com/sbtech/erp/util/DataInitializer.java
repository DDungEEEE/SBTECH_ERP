...
public class DataInitializer {
    ...
    public void initAll() {
        ...
        rolePermissionUseCase.grantPermission(backendDevId, Rank.STAFF.getLabel(), 1L);
        rolePermissionUseCase.grantPermission(backendDevId, Rank.STAFF.getLabel(), 2L);
        rolePermissionUseCase.grantPermission(backendDevId, Rank.STAFF.getLabel(), 3L);
        rolePermissionUseCase.grantPermission(backendDevId, Rank.MANAGER.getLabel(), 1L);
        rolePermissionUseCase.grantPermission(backendDevId, Rank.MANAGER.getLabel(), 2L);
        rolePermissionUseCase.grantPermission(frontendDevId, Rank.DIRECTOR.getLabel(), 3L);
