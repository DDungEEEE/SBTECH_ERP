...
@Table(name = "position_rank_permission",
...
public class PositionRankPermission {
    ...
    @Id
    @Column(name = "position_rank_permission_id")
    ...
    @Builder
    public PositionRankPermission(Position position, Rank rank, Permission permission){
